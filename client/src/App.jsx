...
const Logo = () => (
  <div className="flex items-center gap-2">
    <div className="relative w-8 h-8">
      ...
      <div className="absolute inset-0 flex items-center justify-center text-lg font-bold text-white">T</div>
    </div>
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white font-['Poppins']">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-200 ${
        isScrolled ? 'bg-gray-900/70 backdrop-blur-xl shadow-lg' : 'bg-transparent'
      }`}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button 
                ...
                className={`px-4 py-2 rounded-lg transition-colors ${
                  activePage === 'calendar' ? 'bg-violet-600' : 'hover:bg-gray-800'
                }`}
              >
                Calendar
              </button>
